//
//  FindRidesTableViewController.swift
...
class FindRidesTableViewController: UITableViewController {
   ...
   override func viewDidLoad() {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("findridecell", forIndexPath: indexPath) as! FindRideTableViewCell
        
        print("this is running and object is \(array)")
        for object in array {
